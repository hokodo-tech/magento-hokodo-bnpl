...
class OrderAuthorizationBuilder extends \Hokodo\BNPL\Gateway\Request\AuthorizationBuilder
{
    /**
    ...
    {
        $storeId = null;
        if (isset($buildSubject['orders'])) {
            $searchCriteriaBuilder = $this->criteriaBuilderFactory->create();
            $searchCriteriaBuilder->addFilter('order_api_id', $buildSubject['orders']->getId());
